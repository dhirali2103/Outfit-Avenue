...
function updatePopover(cart) {
    ...
    popStr = popStr + "</div> <a href='/shop/cart/'><button class='btn btn-dark' id ='goCart'>Go to Cart</button></a> <button class='btn btn-dark' onclick='clearCart()' id ='clearCart'>Clear Cart</button>     "
    console.log(popStr);
